...
OBS: Matriz triangular superior = Ser Quadrada + Todos os elementos abaixo da diagonal principal devem ser iguais a zero
'''
    ...
    for i in range(len(matriz)):
        for j in range(len(matriz)):
            if i > j and matriz[i][j] != 0:
                return "A matriz não é uma matriz triangular superior"

    return "A matriz é uma matriz triangular superior"
